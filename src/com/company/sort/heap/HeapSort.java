...
public class HeapSort<E> {
    ...
    public HeapSort(int capacity, boolean isMax) {
    ...
    public void add(E e) {
        ...
        // если минимальная куча
            ...
            if(size > 0) {
                // запоминаем значение size
                int count = size;
                // сдвигаем все элементы вправо пока count > 0
                while(count > 0) {
